        ...
        <div class="col card bg-dark bg-gradient text-white">
            <div class="card-body">
                ...
                <form action="{{ route('access') }}" method="post" class="">
                    ...
                    <input type="email" class="form-control bg-dark-subtle text-dark-emphasis fw-bold" name="email"
                        id="email" autocomplete="email" required>

                    <label for="password" class="label-control">Contraseña:</label>
                    <input type="password" class="form-control bg-dark-subtle text-dark-emphasis fw-bold" name="password"
