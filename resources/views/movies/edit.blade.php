...
@section('content')
    ...
    <form action=" {{route('movies.update', $movie['id'])}}" method="POST" style=""
        ...
        <div class="col my-auto">
            ...
            <input type="text" name="title" id="title" value="{{old('title', $movie['title'])}}"
                class="form-control mb-3 fw-bold border-none" required>

            <label for="description" class="form-label">Descripcion:</label>
            <textarea name="description" id="description" class="form-control mb-3" style="height: 6rem" 
            required>{{ old('description', $movie['description']) }}</textarea>
        </div>

        <div class="col">
            <label for="comments" class="form-label">Comentarios:</label>
            <textarea name="comments" id="comments" class="form-control mb-3" style="height: 6rem" 
        ...
        <div class="mx-auto">
            ...
            <input type="number" min="1" max="10" name="final_note" id="final_note"
                value="{{old('final_note', $movie['final_note'])}}" class="form-control mb-3 text-center mx-auto"
